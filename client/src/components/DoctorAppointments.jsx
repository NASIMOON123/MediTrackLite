        ...
        {appointments.length === 0 ? (
          ...
          appointments.map((app) => (
            <div key={app._id} className="card theme-card">
              <p className="text-adaptive"><strong className="text-adaptive">Patient:</strong> {app.patientName}</p>
              <p className="text-adaptive"><strong className="text-adaptive">Symptoms:</strong> {app.symptoms}</p>
              <p className="text-adaptive"><strong className="text-adaptive">Date:</strong> {app.date}</p>
              <p className="text-adaptive"><strong className="text-adaptive">Time:</strong> {app.time}</p>
              <p className="text-adaptive"><strong className="text-adaptive">Status:</strong> <span className={`status ${app.status.toLowerCase().replace(' ', '-')}`}>{app.status}</span></p>
