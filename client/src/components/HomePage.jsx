...
const HomePage = () => {
  ...
  return (
    <>
      {/* Navbar */}
      {/* <Navbar bg="primary" variant="dark" expand="lg" fixed="top" className="shadow-sm p-2"> */}
      <Navbar expand="lg" fixed="top" className="custom-navbar shadow-sm p-2">

        <Container>
          <Navbar.Brand href="#" className="text-adaptive">🩺 MediTrack Lite</Navbar.Brand>
  ...
  <ThemeToggle />
      ...
      {/* <section id="about" className="py-5 bg-light text-center"> */}
      <section id="about" className="py-5 text-center themed-section">
        <Container>
          <h2 className="mb-4">About Us</h2>
          <Row className="align-items-center">
            <Col md={6}>
              <h2 className="text-primary mb-3">About MediTrack Lite</h2>
              <p className="text-adaptive">MediTrack Lite is a modern web platform designed to connect doctors and patients...</p>
              <ul className="text-adaptive text-start ms-4">
                <li>Easy online appointment booking</li>
                <li>Role-based login for Admin, Doctors, and Patients</li>
                <li>Real-time schedule tracking</li>
                <li>Secure and responsive user interface</li>
...
<section id="services" className="py-5 text-center themed-section">
  <h2 className="mb-4">Our Services</h2>
  <Container>
    <Row className="justify-content-center">
      {[
        ...
        <Col md={3} key={i} className="mb-4 d-flex">
          <Card
            className="border-0 shadow-sm w-100 theme-card"
            style={{ ...cardHoverStyle }}
            onMouseEnter={(e) => Object.assign(e.currentTarget.style, cardHoverEffect)}
            onMouseLeave={(e) => Object.assign(e.currentTarget.style, cardHoverStyle)}
          >
            <Card.Body className="d-flex flex-column align-items-center justify-content-between text-center" style={{ height: '100%' }}>
              ...
              />
              <div className="mt-auto">
                <Card.Title className="fw-bold text-adaptive" style={{ fontSize: '15px' }}>{s.title}</Card.Title>
                <p className="text-adaptive" style={{ fontSize: '12px' }}>{s.desc}</p>
              </div>
            </Card.Body>
          </Card>
        </Col>
